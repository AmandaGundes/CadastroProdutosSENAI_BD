...
import com.senai.br.projeto01.database.contract.ProdutoContract;
import com.senai.br.projeto01.database.entity.ProdutoEntity;
...
public class ProdutoDAO {
    ...
    public boolean excluir(Produto produto) {
        ...
        return dbGateway.getDatabase().delete(ProdutoEntity.TABLE_NAME,
                ProdutoEntity._ID + "=?", new String[]{String.valueOf(produto.getId())}) > 0;
    }
